    ...
    public class LocalizationService
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Strings = new()
        {
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["Settings_BuyMeCoffeeDesc"] = "If Pro is too much, support with a coffee!",
            ...
            ["ko"] = new Dictionary<string, string>
            {
                ...
                ["Settings_BuyMeCoffee"] = "Buy me a coffee",
                ["Settings_BuyMeCoffeeDesc"] = "Pro 구매가 부담스럽다면, 커피 한 잔으로 응원해 주세요!",
            ...
            ["ja"] = new Dictionary<string, string>
            {
                ...
                ["Settings_BuyMeCoffee"] = "Buy me a coffee",
                ["Settings_BuyMeCoffeeDesc"] = "Proが負担なら、コーヒー1杯で応援してください！",
