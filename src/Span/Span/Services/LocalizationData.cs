    ...
    public partial class LocalizationService
    {
        internal static readonly (string key, string en, string ko, string ja, string zhHans, string zhHant, string de, string es, string fr, string ptBR)[] Entries =
        {
            ...
            ("Settings_DefaultViewModeDesc",
             "Default view used when opening a folder if no previously used view is available.",
             "폴더 진입 시 사용할 기본 뷰. 이전에 열었던 뷰가 없을 때 적용됩니다.",
             "Default view used when opening a folder if no previously used view is available.",
             "Default view used when opening a folder if no previously used view is available.",
             "Default view used when opening a folder if no previously used view is available.",
             "Default view used when opening a folder if no previously used view is available.",
            ...
            ("Settings_AutoFitColumnDesc",
             "Automatically widens Miller columns to fit folder and file name lengths.",
             "밀러 컬럼을 폴더/파일 이름 길이에 맞춰 자동으로 넓힙니다 (Column View).",
             "Automatically widens Miller columns to fit folder and file name lengths.",
             "Automatically widens Miller columns to fit folder and file name lengths.",
             "Automatically widens Miller columns to fit folder and file name lengths.",
             "Automatically widens Miller columns to fit folder and file name lengths.",
