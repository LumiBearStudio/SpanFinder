namespace Span.Services
{
    public partial class LocalizationService
    {
        internal static readonly (string key, string en, string ko, string ja, string zhHans, string zhHant, string de, string es, string fr, string ptBR)[] Entries =
        {
            ...
            ("Settings_AccentContrastWarning", "This color may have low contrast against the background and could be hard to read.", "이 색상은 배경과의 대비가 낮아 가독성이 떨어질 수 있습니다.", "この色は背景とのコントラストが低く、読みにくい可能性があります。", "此颜色与背景对比度低，可能难以阅读。", "此色彩與背景對比度低，可能難以閱讀。", "Diese Farbe hat möglicherweise einen geringen Kontrast zum Hintergrund und könnte schwer lesbar sein.", "Este color puede tener poco contraste con el fondo y ser difícil de leer.", "Cette couleur peut avoir un faible contraste avec l'arrière-plan et être difficile à lire.", "Esta cor pode ter baixo contraste com o fundo e ser difícil de ler."),
