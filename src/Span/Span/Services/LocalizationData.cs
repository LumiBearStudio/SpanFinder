namespace Span.Services
{
    public partial class LocalizationService
    {
        internal static readonly (string key, string en, string ko, string ja, string zhHans, string zhHant, string de, string es, string fr, string ptBR)[] Entries =
        {
            ...
            ("Settings_ReduceMotion", "Reduce motion", "애니메이션 줄이기", "モーションを減らす", "减少动画", "減少動畫", "Bewegung reduzieren", "Reducir movimiento", "Réduire les animations", "Reduzir movimento"),
            ("Settings_ReduceMotionDesc", "Disable panel slide-in and selection indicator movement for snappier navigation.", "새 패널 슬라이드-인과 선택 인디케이터 이동 효과를 비활성화하여 더 빠르게 탐색합니다.", "新規パネルのスライドインと選択インジケーターの移動アニメーションを無効化して、よりスナッピーな操作にします。", "禁用新面板滑入和选择指示器移动效果，以获得更快捷的导航体验。", "停用新面板滑入與選取指示器移動效果，以獲得更敏捷的導覽體驗。", "Deaktiviert Einblend-Animation neuer Spalten und Bewegung der Auswahlanzeige für schnellere Navigation.", "Desactiva el deslizamiento de nuevos paneles y el movimiento del indicador de selección para una navegación más ágil.", "Désactive le défilement des nouveaux panneaux et le mouvement de l'indicateur de sélection pour une navigation plus réactive.", "Desativa o deslize de novos painéis e o movimento do indicador de seleção para uma navegação mais ágil."),
