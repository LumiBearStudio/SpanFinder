namespace Span.Services
{
    public partial class LocalizationService
    {
        internal static readonly (string key, string en, string ko, string ja, string zhHans, string zhHant, string de, string es, string fr, string ptBR)[] Entries =
        {
            ...
            ("Menu_FolderTag", "Colour tag", "색상 태그", "カラータグ", "颜色标签", "顏色標籤", "Farbmarkierung", "Etiqueta de color", "Étiquette de couleur", "Etiqueta de cor"),
            ("Tag_None", "None", "없음", "なし", "无", "無", "Keine", "Ninguna", "Aucune", "Nenhuma"),
            ("Tag_Red", "Red", "빨강", "赤", "红色", "紅色", "Rot", "Rojo", "Rouge", "Vermelho"),
            ("Tag_Orange", "Orange", "주황", "オレンジ", "橙色", "橙色", "Orange", "Naranja", "Orange", "Laranja"),
            ("Tag_Yellow", "Yellow", "노랑", "黄", "黄色", "黃色", "Gelb", "Amarillo", "Jaune", "Amarelo"),
            ("Tag_Green", "Green", "초록", "緑", "绿色", "綠色", "Grün", "Verde", "Vert", "Verde"),
            ("Tag_Blue", "Blue", "파랑", "青", "蓝色", "藍色", "Blau", "Azul", "Bleu", "Azul"),
            ("Tag_Purple", "Purple", "보라", "紫", "紫色", "紫色", "Lila", "Morado", "Violet", "Roxo"),
            ("Tag_Gray", "Gray", "회색", "グレー", "灰色", "灰色", "Grau", "Gris", "Gris", "Cinza"),
            ("Settings_FolderTags", "Folder colour tags", "폴더 색상 태그", "フォルダーのカラータグ", "文件夹颜色标签", "資料夾顏色標籤", "Ordner-Farbmarkierungen", "Etiquetas de color de carpeta", "Étiquettes de couleur de dossier", "Etiquetas de cor de pasta"),
            ("Settings_FolderTagsDesc", "Assign colours to folders from the right-click menu. Tags are stored in the folder itself (desktop.ini), so they follow the folder when it is moved or renamed. Local fixed drives only; not shown in File Explorer.", "우클릭 메뉴로 폴더에 색상을 지정합니다. 태그는 폴더 자체(desktop.ini)에 저장되어 폴더를 옮기거나 이름을 바꿔도 유지됩니다. 로컬 고정 드라이브만 지원하며, Windows 탐색기에는 표시되지 않습니다.", "右クリックメニューからフォルダーに色を割り当てます。タグはフォルダー自体(desktop.ini)に保存されるため、移動や名前変更後も保持されます。ローカル固定ドライブのみ対応し、エクスプローラーには表示されません。", "通过右键菜单为文件夹指定颜色。标签保存在文件夹自身(desktop.ini)中，因此移动或重命名后仍会保留。仅支持本地固定驱动器，资源管理器中不显示。", "透過右鍵選單為資料夾指定顏色。標籤儲存在資料夾本身(desktop.ini)，因此移動或重新命名後仍會保留。僅支援本機固定磁碟機，檔案總管中不會顯示。", "Weisen Sie Ordnern über das Kontextmenü Farben zu. Markierungen werden im Ordner selbst (desktop.ini) gespeichert und bleiben beim Verschieben oder Umbenennen erhalten. Nur lokale Festplatten; nicht im Explorer sichtbar.", "Asigna colores a las carpetas desde el menú contextual. Las etiquetas se guardan en la propia carpeta (desktop.ini), por lo que se mantienen al mover o renombrar. Solo unidades locales fijas; no se muestran en el Explorador.", "Attribuez des couleurs aux dossiers depuis le menu contextuel. Les étiquettes sont stockées dans le dossier lui-même (desktop.ini) et suivent donc les déplacements et renommages. Disques locaux fixes uniquement ; non visibles dans l'Explorateur.", "Atribua cores às pastas pelo menu de contexto. As etiquetas ficam na própria pasta (desktop.ini), portanto permanecem ao mover ou renomear. Apenas unidades locais fixas; não aparecem no Explorador."),
            ...
            ("Op_SomeNotExtracted", "Some items could not be extracted", "일부 항목의 압축을 풀 수 없음", "一部の項目を展開できませんでした", "部分项目无法解压", "部分項目無法解壓縮", "Einige Elemente konnten nicht entpackt werden", "Algunos elementos no se pudieron extraer", "Certains éléments n'ont pas pu être extraits", "Alguns itens não puderam ser extraídos"),
            ("Op_CrcMismatch", "Corrupted (checksum mismatch)", "손상됨 (체크섬 불일치)", "破損しています (チェックサム不一致)", "已损坏 (校验和不匹配)", "已損毀 (總和檢查碼不符)", "Beschädigt (Prüfsummenfehler)", "Dañado (suma de comprobación no coincide)", "Corrompu (somme de contrôle incorrecte)", "Corrompido (checksum não corresponde)"),
            // Issue #66 — 네이티브 아카이브 엔진 오류 매핑
            ("Op_ExtractFailed", "Could not extract the archive", "압축을 풀 수 없음", "アーカイブを展開できませんでした", "无法解压该压缩包", "無法解壓縮此封存檔", "Archiv konnte nicht entpackt werden", "No se pudo extraer el archivo comprimido", "Impossible d'extraire l'archive", "Não foi possível extrair o arquivo"),
            ("Op_ArchivePasswordRequired", "This archive needs a password", "암호가 필요한 압축 파일", "このアーカイブにはパスワードが必要です", "此压缩包需要密码", "此封存檔需要密碼", "Dieses Archiv benötigt ein Kennwort", "Este archivo requiere una contraseña", "Cette archive nécessite un mot de passe", "Este arquivo requer uma senha"),
            ("Op_ArchiveCorrupted", "The archive is damaged", "손상된 압축 파일", "アーカイブが破損しています", "压缩包已损坏", "封存檔已損毀", "Das Archiv ist beschädigt", "El archivo comprimido está dañado", "L'archive est endommagée", "O arquivo está danificado"),
            ("Op_ArchiveUnsupported", "This archive format is not supported", "지원하지 않는 압축 형식", "このアーカイブ形式はサポートされていません", "不支持此压缩格式", "不支援此封存檔格式", "Dieses Archivformat wird nicht unterstützt", "Este formato de archivo no es compatible", "Ce format d'archive n'est pas pris en charge", "Este formato de arquivo não é suportado"),
            ("Op_ArchiveMissingVolume", "A part of this split archive is missing", "분할 압축 파일의 일부가 없음", "分割アーカイブの一部が見つかりません", "分卷压缩包缺少部分文件", "分割封存檔缺少部分檔案", "Ein Teil dieses geteilten Archivs fehlt", "Falta una parte de este archivo dividido", "Une partie de cette archive fractionnée est manquante", "Falta uma parte deste arquivo dividido"),
            ("Op_ArchiveEntryNotFound", "That item is not in the archive", "압축 파일에 없는 항목", "その項目はアーカイブ内にありません", "压缩包中没有该项目", "封存檔中沒有該項目", "Dieses Element ist nicht im Archiv enthalten", "Ese elemento no está en el archivo comprimido", "Cet élément ne figure pas dans l'archive", "Esse item não está no arquivo"),
            ("Op_ArchiveUnsafePath", "The archive contains an unsafe file path", "안전하지 않은 경로가 포함된 압축 파일", "アーカイブに安全でないファイルパスが含まれています", "压缩包中包含不安全的文件路径", "封存檔包含不安全的檔案路徑", "Das Archiv enthält einen unsicheren Dateipfad", "El archivo contiene una ruta de archivo insegura", "L'archive contient un chemin de fichier non sécurisé", "O arquivo contém um caminho de arquivo inseguro"),
            ("Op_ArchiveTooLarge", "Not enough space to extract this archive", "압축을 풀 공간이 부족함", "このアーカイブを展開する空き容量が足りません", "空间不足，无法解压该压缩包", "空間不足，無法解壓縮此封存檔", "Nicht genügend Speicherplatz zum Entpacken", "No hay espacio suficiente para extraer este archivo", "Espace insuffisant pour extraire cette archive", "Espaço insuficiente para extrair este arquivo"),
            ("Op_ArchiveDiskFull", "The disk is full", "디스크 공간이 부족함", "ディスクの空き容量がありません", "磁盘已满", "磁碟已滿", "Der Datenträger ist voll", "El disco está lleno", "Le disque est plein", "O disco está cheio"),
            ("Op_ArchivePermissionDenied", "No permission to write to that folder", "해당 폴더에 쓸 권한이 없음", "そのフォルダーへの書き込み権限がありません", "没有写入该文件夹的权限", "沒有寫入該資料夾的權限", "Keine Schreibberechtigung für diesen Ordner", "Sin permiso para escribir en esa carpeta", "Aucune autorisation d'écriture dans ce dossier", "Sem permissão para gravar nessa pasta"),
            ("Op_ArchiveNotFound", "The archive file was not found", "압축 파일을 찾을 수 없음", "アーカイブファイルが見つかりません", "找不到该压缩包", "找不到該封存檔", "Archivdatei nicht gefunden", "No se encontró el archivo comprimido", "Fichier d'archive introuvable", "Arquivo compactado não encontrado"),
            // Issue #67 — 서버 루트(\\server)는 공유 목록만 보여주는 읽기 전용 위치다
            ("Toast_NetworkRootReadOnly", "Open a shared folder first — you cannot save here", "공유 폴더를 먼저 열어야 합니다 — 여기에는 저장할 수 없음", "共有フォルダーを開いてください — ここには保存できません", "请先打开共享文件夹 — 无法保存到此处", "請先開啟共用資料夾 — 無法儲存至此", "Öffnen Sie zuerst einen freigegebenen Ordner — hier kann nicht gespeichert werden", "Abra primero una carpeta compartida: aquí no se puede guardar", "Ouvrez d'abord un dossier partagé — impossible d'enregistrer ici", "Abra primeiro uma pasta compartilhada — não é possível salvar aqui"),
            ...
            // ── Settings UI (Tools / Onboarding / Browsing 카드 누락분) ──
            ("Settings_OpenLogs", "Open log folder", "로그 폴더 열기", "ログフォルダーを開く", "打开日志文件夹", "開啟記錄檔資料夾", "Log-Ordner öffnen", "Abrir carpeta de registros", "Ouvrir le dossier de journaux", "Abrir pasta de logs"),
            ("Settings_OpenLogsDesc", "Opens the folder where Span debug logs are stored. Attach when reporting issues.", "Span 디버그 로그가 저장된 폴더를 엽니다. 문제 보고 시 첨부에 사용하세요.", "Spanのデバッグログが保存されたフォルダーを開きます。問題報告時に添付してください。", "打开存储 Span 调试日志的文件夹。报告问题时附加使用。", "開啟儲存 Span 偵錯記錄的資料夾。回報問題時附加使用。", "Öffnet den Ordner mit Span-Debugprotokollen. Beim Melden von Problemen anhängen.", "Abre la carpeta donde se almacenan los registros de depuración de Span. Adjunta al reportar problemas.", "Ouvre le dossier contenant les journaux de débogage de Span. À joindre lors du signalement de problèmes.", "Abre a pasta onde os logs de depuração do Span são armazenados. Anexe ao reportar problemas."),
            ("Settings_IsolatedThumbs", "Thumbnail isolation (recommended)", "썸네일 격리 (권장)", "サムネイル分離 (推奨)", "缩略图隔离（推荐）", "縮圖隔離（建議）", "Miniaturansicht-Isolation (empfohlen)", "Aislamiento de miniaturas (recomendado)", "Isolation des miniatures (recommandé)", "Isolamento de miniaturas (recomendado)"),
            ("Settings_IsolatedThumbsDesc", "Generates video/image thumbnails in a separate process to prevent crashes when entering folders. Some thumbnails may not display.", "동영상/이미지 썸네일을 별도 프로세스에서 생성하여 폴더 진입 시 크래시를 방지합니다. 일부 파일의 썸네일이 표시되지 않을 수 있습니다.", "動画/画像のサムネイルを別プロセスで生成し、フォルダー進入時のクラッシュを防止します。一部のファイルのサムネイルが表示されない場合があります。", "在独立进程中生成视频/图像缩略图，以防止进入文件夹时崩溃。部分文件的缩略图可能不显示。", "在獨立程序中產生影片/影像縮圖，避免進入資料夾時當機。部分檔案的縮圖可能不會顯示。", "Erstellt Video-/Bild-Miniaturansichten in einem separaten Prozess, um Abstürze beim Öffnen von Ordnern zu verhindern. Manche Miniaturansichten werden möglicherweise nicht angezeigt.", "Genera miniaturas de video/imagen en un proceso separado para evitar bloqueos al entrar en carpetas. Algunas miniaturas pueden no mostrarse.", "Génère les miniatures vidéo/image dans un processus séparé pour éviter les plantages à l'entrée des dossiers. Certaines miniatures peuvent ne pas s'afficher.", "Gera miniaturas de vídeo/imagem em um processo separado para evitar travamentos ao entrar em pastas. Algumas miniaturas podem não ser exibidas."),
            ...
            ("Settings_OnboardingReplay", "Replay onboarding", "온보딩 다시 보기", "オンボーディングを再生", "重新播放新手引导", "重新播放新手引導", "Einführung wiederholen", "Reproducir guía de inicio", "Rejouer l'intégration", "Reproduzir introdução"),
